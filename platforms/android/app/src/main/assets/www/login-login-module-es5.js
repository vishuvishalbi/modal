...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(menu, loader, screenOrientation) {
        this.menu = menu;
        this.loader = loader;
    ...
    LoginComponent.prototype.clicked = function (number) {
        this.phone += '' + number;
    };
    LoginComponent.prototype.delete = function () {
        this.phone.substring(0, this.phone.length - 1);
    };
    LoginComponent.prototype.lookupUser = function () {
        this.l.present();
    };
    LoginComponent.prototype.initiateLoader = function () {
